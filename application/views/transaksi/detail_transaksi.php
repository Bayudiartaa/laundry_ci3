            ...
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <?php foreach($transaksidet as $d) : ?>
                        <td><?= $i++;?></td>
                        <td><?= $d['nama_paket'];?></td>
                        <td>Rp. <?= rupiah($d['harga_satuan']);?></td>
                        <td><?= $d['jumlah'];?></td>
                        <td>Rp. <?= rupiah($d['total']);?></td>
                    </tr>
                    <?php endforeach;?>
                    <tr>
                        <td colspan="4" class="bg-primary"><center><b class="text-white">Total Transaksi</center></b></td>
                        <td><input type="text" id="txt1" class="form-control" value="Rp. <?= rupiah($totaltrans['totaltransaksi']);?>" disabled></td>
                    </tr>
                    <tr>
